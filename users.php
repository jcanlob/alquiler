		...
		<div class="card col-lg-12">
			...
			<tbody>
				<?php
 					...
 					$type = array("","Administrador","Gestor","Invitado");
...
$('.delete_user').click(function(){
		_conf("¿Estás seguro de querer borrar este usuario?","delete_user",[$(this).attr('data-id')])
	})
	function delete_user($id){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp==1){
					alert_toast("Datos borrados correctamente",'success')
					setTimeout(function(){
						location.reload()
					},1500)
