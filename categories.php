	...
	<div class="col-lg-12">
		<div class="row">
			...
			<div class="col-md-8">
				<div class="card">
					<div class="card-header">
						<b>Lista de Tipo de Propiedad</b>
					</div>
					<div class="card-body">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_category" type="button" data-id="<?php echo $row['id'] ?>"  data-name="<?php echo $row['name'] ?>" >Editar</button>
...
<script>
	...
	$('.delete_category').click(function(){
		_conf("¿Estás seguro de eliminar este tipo de Propiedad?","delete_category",[$(this).attr('data-id')])
	})
